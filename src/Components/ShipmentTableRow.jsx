const ShipmentTableRow = ({ customerName, product, quantity, price, highlighted, onClick }) => {
  return (
    <div 
    className={`grid grid-cols-12 gap-2 px-4 py-3 items-center ${highlighted ? 'bg-gray-50' : ''} cursor-pointer`}
    onClick={onClick}
