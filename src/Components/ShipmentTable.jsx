...
const ShipmentTable = () => {
  ...
  return (
    ...
    >
        ...
        <table className="w-full table-auto border-collapse border-spacing-0">
          ...
          <thead className="bg-gray-50">
            <tr className="">
              ...
              <th className="px-3 py-3 text-center text-xs md:text-sm font-medium text-gray-500 ">
                <div className="flex items-center justify-center gap-2">
                  <img src="/Icones/price.svg" alt="سعر" className="w-4 h-4" />
                  <span>السعر</span>
                </div>
              </th>
                    ...
                    <td colSpan="5" className="px-2 py-3 bg-blue-50">
                      <div className="p-3 md:p-4 text-center rounded-xl border border-solid bg-slate-50 border-neutral-200">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                          ...
                          />
                          <DetailItem label="المنتج" value={shipment.product} />
                          <DetailItem
                            label="الكمية"
      ...
      <button className="self-center rounded-lg bg-red-100 px-4 py-2 mt-6 text-sm md:text-base w-full md:w-auto">
        تأكيد الطلب
      </button>
    </section>
  );
