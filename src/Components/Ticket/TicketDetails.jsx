    ...
    <div className="text-right mb-4" dir="rtl">
      ...
      <div className="flex flex-col bg-white p-4 md:p-6 rounded-2xl shadow-sm">
        ...
        <div className="flex  justify-between items-center mb-4 md:mb-6">
          <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-4 gap-4 w-full">
        ...
        <div className="mt-2 md:mt-3">
          ...
          <div className="text-sm md:text-base bg-gray-50 border border-gray-200 p-3 rounded-lg font-medium">
            {ticketDetails}
          </div>
        </div>
        ...
        {showDetails && (
          <div className="text-right border-t border-gray-200 pt-4 mt-4">
            <h4 className="text-base md:text-lg font-semibold text-pink-900 mb-3">
              تفاصيل اضافية
            </h4>
