...
const ShippingCompanyCard = ({
  ...
  return (
    <article
      className={`flex flex-col w-full bg-white rounded-2xl border border-pink-950 border-opacity-20 overflow-hidden transition-all duration-300 ${
    ...
    >
      ...
      <div className="p-4 md:p-6">
        <div className="grid grid-cols-1 gap-6">
          {/* Cities Section */}
          <div>
            <h4 className="text-lg font-semibold text-pink-950 mb-2">
              أهم المدن
            </h4>
