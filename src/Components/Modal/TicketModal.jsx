          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className=" text-start mb-4">
              ...
              <input
                ...
                className="p-3 w-full rounded-lg border border-gray-200 focus:border-red-300 focus:ring-2 focus:ring-red-200 transition-colors"
              />
            </div>
            ...
            <div className=" text-start mb-4 md:col-span-2">
              ...
              <textarea
                ...
                onChange={handleChange}
                className="p-3 max-md:w-full  w-[80%] rounded-lg border border-gray-200 focus:border-red-300 focus:ring-2 focus:ring-red-200 transition-colors resize-none h-32"
              />
            </div>
          </div>
