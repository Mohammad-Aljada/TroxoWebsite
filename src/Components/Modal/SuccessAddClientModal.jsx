export default function SuccessAddClientModal({ onClose }) {
    return (
      <div
      ...
      >
        <div className="relative p-6 sm:p-10 text-center bg-white rounded-2xl w-full max-w-[930px] mx-4 sm:mx-0 sm:w-[90%] md:w-[80%] lg:w-[930px]">
          <img
            src="/Icones/SucessClient.svg"
            alt="Success add client"
          ...
          <div>
            ...
            <p className="mb-6 sm:mb-8 text-sm sm:text-base text-zinc-800 px-2 sm:px-0">
              تمت إضافة العميل بنجاح تمت إضافة العميل بنجاح تمت إضافة العميل بنجاح
            </p>
            <button
              onClick={onClose}
