    ...
    <section className="w-full p-4 sm:p-5 md:p-6 lg:p-7 xl:p-8 bg-white rounded-2xl shadow-sm">
      ...
      <div className="flex flex-col lg:flex-row gap-4 md:gap-5 lg:gap-6 xl:gap-8 justify-between items-start md:items-center mb-6">
        ...
        <div className="flex gap-2 sm:gap-3 md:gap-4 w-full sm:w-auto">
          ...
          <Button
            variant="secondary"
            icon="https://cdn.builder.io/api/v1/image/assets/33cf6ee4ee4e4cdd8b24ad2c5832d456/1e95660b64d80ec70fafcd1a47dbccf9a97e8de4?placeholderIfAbsent=true"
            className="bg-red-100 text-pink-950 text-sm sm:text-base md:text-[15px] lg:text-base"
            name="إضافة شحنات"
          >
            إضافة شحنات
          </Button>
