...
const Company = () => {
  ...
  return (
    <main className="bg-white min-h-screen pb-20 px-4 sm:px-6 lg:pl-4" dir="rtl">
          ...
          <section className="w-full">
            <div className="flex flex-col mt-6 md:mt-9 w-full">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 w-full">
                ...
                <button className="flex items-center justify-center gap-2 px-4 py-3 text-lg font-medium rounded-2xl border border-neutral-400 hover:bg-gray-50 transition-colors">
