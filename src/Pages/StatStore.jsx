...
export default function StatStore() {
    ...
    <main className="overflow-hidden pb-10 bg-gray-100">
        ...
        <section className="ml-5  max-md:ml-0 max-md:w-full">
          <div className="w-full max-md:max-w-full">
            ...
            <button className="flex overflow-hidden gap-1.5 px-6 py-2 my-auto text-base font-bold tracking-tight leading-none text-center bg-red-100 rounded-lg text-pink-950" aria-label="Export file">
                <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/0b6acb5c4f6f19bf5703d6fcac436f04cd319295?placeholderIfAbsent=true&apiKey=e1766207373343d5b51643e9485c07fc" alt="" className="object-contain shrink-0 w-6 aspect-square" />
  ...
  <div className="flex gap-5 sm:gap-4 md:gap-5 flex-col max-md:gap-3 lg:gap-3">
